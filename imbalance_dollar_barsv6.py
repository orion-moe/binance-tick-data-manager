...
def process_files_and_generate_bars(
    ...
    output_file_prefix = f'{timestamp}-{data_type}-imbalance_dollar_bars_ticks{init_ticks}-aticks{alpha_ticks}-aimb{alpha_imbalance}-treset{time_reset}'
    ...
    if all_bars:
        ...
        df_all_bars['sample'] = output_file_prefix
