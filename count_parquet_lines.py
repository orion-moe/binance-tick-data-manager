#!/usr/bin/env python3
"""
Script to count lines in compressed parquet files from daily raw spot and futures-um datasets.
"""
...
def main():
    # Base directories for datasets - trying both compressed and optimized
    base_dirs = [
        "datasets/dataset-raw-daily-compressed",
        "datasets/dataset-raw-daily-compressed-optimized"
    ]
